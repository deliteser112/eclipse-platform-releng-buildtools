...
*   [Bazel build system](http://bazel.io/) (version [0.11.0][bazel-version]
    works as of 2018-02-26).
...
[bazel-version]: https://github.com/bazelbuild/bazel/releases/download/0.11.0/bazel-0.11.0-installer-linux-x86_64.sh
