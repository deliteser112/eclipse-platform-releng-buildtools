...
*   [Bazel build system](http://bazel.io/) (version [0.10.1][bazel-version]
    works as of 2018-02-20).
...
[bazel-version]: https://github.com/bazelbuild/bazel/releases/download/0.10.1/bazel-0.10.1-installer-linux-x86_64.sh
