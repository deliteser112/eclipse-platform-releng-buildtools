...
*   [Bazel build system](http://bazel.io/) (version [0.12.0][bazel-version]
    works as of 2018-04-24).
...
[bazel-version]: https://github.com/bazelbuild/bazel/releases/download/0.12.0/bazel-0.12.0-installer-linux-x86_64.sh
