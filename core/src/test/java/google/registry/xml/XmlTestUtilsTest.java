...
class XmlTestUtilsTest {
  ...
  @Test
  void testSelfEquality() throws Exception {
  ...
  @Test
  void testMultipleElementsInDifferentNamespaces() throws Exception {
    runTest("twoextensions_feeThenLaunch.xml", "twoextensions_launchThenFee.xml");
  }

  @Test
  void testMultipleElementsInDifferentNamespaces_differentValues() {
    assertThrows(
